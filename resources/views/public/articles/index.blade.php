...
<section class="py-24 pt-36 md:pt-44 bg-background min-h-screen">
    <div class="max-w-container-max mx-auto px-4 md:px-margin-desktop">
        <div class="text-center max-w-3xl mx-auto mb-16">
            <span class="text-primary font-label-md text-label-md tracking-widest uppercase mb-2 block font-bold">Jendela Budaya</span>
            <h1 class="font-headline-lg text-3xl md:text-5xl mb-6 font-black leading-tight text-on-background">Artikel & Kabar Seni</h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">Informasi terbaru, wawasan kebudayaan, dan kabar pertunjukan dari GSBK Candi.</p>
        </div>
        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                @foreach($articles as $article)
                    <article class="bg-surface-container-low border border-gold-subtle rounded-2xl overflow-hidden hover:border-primary/50 transition-all duration-300 flex flex-col group shadow-sm">
                        ...
                        <div class="p-6 flex-1 flex flex-col justify-between">
                            ...
                            <div class="pt-4 border-t border-gold-subtle flex justify-between items-center text-xs text-on-surface-variant">
